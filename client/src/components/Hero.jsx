...
export default function Hero() {
  return (
    <section className="relative w-full min-h-screen flex items-center justify-center pt-16">
      <div className="container mx-auto px-4 md:px-8 -mt-28 md:-mt-32">
        <div className="flex flex-col items-center justify-center">
          <div className="w-full max-w-2xl space-y-6 text-center">
            ...
            <p className="text-xl md:text-2xl font-light text-white max-w-[600px] mx-auto">
              Full-stack developer, CS junior, <br /> and AI/ML enthusiast
            </p>
