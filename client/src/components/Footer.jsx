...
export default function Footer() {
    return (
        <footer className="py-8 md:py-16 bg-white dark:bg-white">
            <div className="mx-auto max-w-5xl px-6">
                ...
                <div className="my-8 flex flex-wrap justify-center gap-6 text-sm">
                    <span>You have made it to the bottom :p</span>
                </div>

                <span className="text-muted-foreground block text-center text-sm"> © {new Date().getFullYear()} tyci, All rights reserved</span>
            </div>
        </footer>
    )
}
